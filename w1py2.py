...
def isSpace(index, cypherTextIndex):
    ...
    if (cout > 9 ):                                                         # vi con 1 so truong hop xor không ra chu cai alpha( do cac dau câu , ....) nen cout se linh dong 1 vai gia tri (cout max = 11) , chay thu 1 vai gia tri thi thay cout = 8 la ra dc van ban nhieu nhat
        return True
    else : 
        return False
